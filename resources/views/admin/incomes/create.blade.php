...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('branch_id', trans('quickadmin.income.fields.branch').'*', ['class' => 'control-label']) !!}
                     {!! Form::hidden('branch_id',$branches->id, old('branch_id'), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    {{--  {!! Form::select('branch_id', $branches, old('branch_id'), ['class' => 'form-control select2', 'required' => '']) !!}  --}}
